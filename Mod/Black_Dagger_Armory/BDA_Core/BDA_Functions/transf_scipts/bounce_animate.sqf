...
null= [[_nclass,_al_rock_bounce_speed,_al_bounce_distance,_dist_dependent,_poz_obj,_alt_obj],"BDA_Core\BDA_Functions\transf_scipts\bounce.sqf"] remoteExec ["execVM",0,true];